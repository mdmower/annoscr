...
**Editing:** Per-tool color, fill, stroke width, line style (solid/dashed/dotted), font family, font size; select one or several annotations (Shift+Click) to move, delete, or restyle them together; undo/redo; discard confirmation
