...
```sh
gpg --verify annoscr_1.1.0_all.deb.asc annoscr_1.1.0_all.deb

gpg --verify annoscr-1.1.0-1-any.pkg.tar.zst.sig annoscr-1.1.0-1-any.pkg.tar.zst
```
...
# install
sudo pacman -U ./annoscr-1.1.0-1-any.pkg.tar.zst
```
